Ext.define('Seller.view.person.Person',{
    extend : 'Ext.grid.Panel',
    requires: [
        'Seller.store.PersonStore',
       // 'Seller.store.PersonSelectedColumnStore',
    ],
    alias: 'widget.person',
    initComponent: function(){
            var personStore = Ext.create('Seller.store.PersonStore');
            //var personSelectedColumnStore = Ext.create('Seller.store.MessageSelectedColumnStore');
            //初始化标签中的Ext:Qtip属性。
            Ext.QuickTips.init();
